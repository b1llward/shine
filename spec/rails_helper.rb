...
# Installing Poltergeist will bring in Capybara as a dependency
require 'capybara/poltergeist'

#
# Configure Capybara to use Poltergeist to use it during testing runs
...
RSpec.configure do |config|
  ...
  # instead of true.
  #
  # DatabaseCleaner will be handling testing transactions to the DB
  #
